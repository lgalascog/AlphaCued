...
% Flip pre_stim
vbl_fixation = Screen('Flip',myWindow,INFO.P.paradigm_blank-.5*INFO.P.setup.ITI);
...
%Gaze Control
if INFO.P.setup.isEYEtrack
    Tmin = INFO.P.paradigm_precue_train2_norm - INFO.P.setup.ITI;
...
% Flip Cue
vbl_cue = Screen('Flip', myWindow, vbl_fixation + INFO.P.paradigm_precue_train2-.5*INFO.P.setup.ITI);
...
% Gaze control
if INFO.P.setup.isEYEtrack
    Tmin = INFO.P.paradigm_stim_train2_norm - INFO.P.setup.ITI;
    [~, ~, hsmvd] = EyelinkControlFixation(INFO.P.E,...
        Tmin, 0.002, [INFO.P.CenterX, INFO.P.CenterY],...
        INFO.P.E.FixLenDeg, INFO.P.setup.isEYEtrack, INFO.P.screen.pixperdeg,...
        0, INFO.P.E.IgnoreBlinks);
...
% Flip target
vbl_target = Screen('Flip', myWindow, vbl_delay1  + INFO.P.paradigm_stim_train2-.5*INFO.P.setup.ITI);
...
my_optimal_fixationpoint(myWindow, INFO.P.screen.cx, INFO.P.screen.cy,...
    INFO.P.stim.fixation_size, INFO.P.stim.fixation_square_color,...
    INFO.P.stim.background_color, INFO.P.screen.pixperdeg);
vbl_delay2 = Screen('Flip', myWindow, vbl_target + INFO.P.paradigm_delay_before_question-.5*INFO.P.setup.ITI);
...
vbl_feedback = Screen('Flip', myWindow, vbl_delay2 + (INFO.P.paradigm_ITI/2)-.5*INFO.P.setup.ITI);
...
my_optimal_fixationpoint(myWindow, INFO.P.screen.cx, INFO.P.screen.cy,...
    INFO.P.stim.fixation_size, INFO.P.stim.fixation_square_color,...
    INFO.P.stim.background_color, INFO.P.screen.pixperdeg);
Screen('Flip', myWindow, vbl_feedback + (INFO.P.paradigm_ITI/2)-.5*INFO.P.setup.ITI);
