...
location_probes_right = INFO.P.center_right(:,location_probes_number_right);
location_probes_left = INFO.P.center_left(:,location_probes_number_left);

if INFO.T(itrial).probes == 1
    Screen('BlendFunction', myWindow, GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA);
    Screen('DrawDots', myWindow, [location_probes_right], INFO.P.circle_detection_size_pix, color, [], 2);
...
if INFO.T(itrial).probes == 2
    Screen('BlendFunction', myWindow, GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA);
    Screen('DrawDots', myWindow, [location_probes_left], INFO.P.circle_detection_size_pix, color, [], 2);
    my_optimal_fixationpoint(myWindow, INFO.P.screen.cx, INFO.P.screen.cy,... 
        INFO.P.stim.fixation_size, INFO.P.stim.fixation_square_color,... 
        INFO.P.stim.background_color, INFO.P.screen.pixperdeg)
    Screen('Flip', myWindow);
